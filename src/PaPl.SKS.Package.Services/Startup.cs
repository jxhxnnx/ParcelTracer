...
using PaPl.SKS.Package.Services.Filters;
...
namespace PaPl.SKS.Package.Services
{
    ...
    public class Startup
    {
        ...
        {
            //Add Transient --- lifetime : for usage
            services.AddTransient<ITransitionLogic, TransitionLogic>();
            services.AddTransient<ITrackParcelLogic, TrackParcelLogic>();
            services.AddTransient<ISubmitParcelLogic, SubmitParcelLogic>();
            services.AddTransient<IReportParcelLogic, ReportParcelLogic>();
            services.AddTransient<IWarehouseLogic, WareHouseLogic>();
            services.AddTransient<IWebhookLogic, WebhookLogic>();
            //Add Scoped --- lifetime : for every request
            services.AddScoped<DbContext, SQLDataContext>();
            ...
            services.AddDbContext<SQLDataContext>(options => options
            .UseSqlServer(Configuration.GetConnectionString("Default")
            //Config Database
            //---Give NEtTopologyContext
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            using (var serviceScope = app.ApplicationServices.GetService<IServiceScopeFactory>().CreateScope())
            {
                ...
                var context = serviceScope.ServiceProvider.GetRequiredService<SQLDataContext>();
